...
select departamentos.nombre, empleados.nombre, departamentos.presupuesto, departamentos.estado from empleados inner join departamentos on empleados.emplaedo_id - departamentos.departamento_id ;
